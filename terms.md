...
- Harass, bully, stalk, or intimidate any other user.
- Solicit personal information from minors.
- Post content that infringes any intellectual property right, privacy right, or other right of any party.
- Post spam, chain letters, pyramid schemes, or other unsolicited promotional content.
- Use the App for any commercial purpose without our prior written consent.
- Attempt to gain unauthorized access to any part of the App, other accounts, or computer systems connected to the App.
- Interfere with, disrupt, or place an unreasonable load on the App or its servers.
- Use automated means (bots, scrapers) to access the App.
- Violate any applicable law or regulation.

## 5. Content Moderation

We have **zero tolerance for objectionable content and abusive behavior**. Within the App, you can:

- **Report** any user or content that violates these Terms from any profile or broadcast.
- **Block** any user, which immediately prevents them from contacting you or seeing your content.

We review reports within 24 hours and may remove content, suspend accounts, or permanently terminate accounts that violate these Terms. We may take action with or without notice.

## 6. Termination

We may suspend or terminate your account at any time, with or without notice, for any conduct that we believe violates these Terms, harms other users, or harms our business.

You may delete your account at any time from the You tab within the App. Deletion is immediate and permanent.
...
We may update these Terms from time to time. If we make material changes, we will notify you within the App or by other reasonable means. Continued use of the App after changes take effect constitutes your acceptance of the revised Terms.

## 10. Governing Law

These Terms are governed by the laws of the State of California, United States, without regard to its conflict of law principles. Any dispute arising out of these Terms will be resolved in the state or federal courts located in Los Angeles County, California.

## 11. Contact

If you have questions about these Terms, contact us at:

**zacrosemusic@gmail.com**
